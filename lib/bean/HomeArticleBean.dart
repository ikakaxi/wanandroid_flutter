/// author:liuhaichao
/// description:首页文章列表
/// create date：2020-11-09 on 8:33 PM
class HomeArticleBeanList {
  Data data;
  int errorCode;
  String errorMsg;

  HomeArticleBeanList({this.data, this.errorCode, this.errorMsg});

  HomeArticleBeanList.fromJson(Map<String, dynamic> json) {
